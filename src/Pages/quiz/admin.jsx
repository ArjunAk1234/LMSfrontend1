...
function AdminDashboard() {
  ...
  const fetchAllQuizzes = async () => {
    try {
      setLoading(true);
      const response = await axios.get('https://lms1-494718652739.us-central1.run.app/admin/quizzes');
  ...
  const fetchSubmissions = async (quizId) => {
    try {
      setLoading(true);
      const response = await axios.get(`https://lms1-494718652739.us-central1.run.app/admin/submissions/quiz/${quizId}`);
  ...
  const fetchStudentProgress = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.get(`https://lms1-494718652739.us-central1.run.app/admin/student-progress/email/${studentEmail}`);
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          await axios.post('https://lms1-494718652739.us-central1.run.app/admin/create-quiz', {
            title,
            questions,
