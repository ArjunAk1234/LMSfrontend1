...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://lms1-494718652739.us-central1.run.app/courses/summary')
      .then(res => {
    ...
    axios.get('https://lms1-494718652739.us-central1.run.app/assignments')
      .then(res => {
    ...
    axios.get('https://lms1-494718652739.us-central1.run.app/active-quizzes')
      .then(res => {
    ...
    axios.get('https://lms1-494718652739.us-central1.run.app/leaderboard/me', {
      headers: {
