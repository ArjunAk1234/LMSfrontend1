...
const Leaderboard = () => {
  ...
  const fetchLeaderboard = async () => {
    try {
      const endpoint = isAdmin
        ? "https://lms1-494718652739.us-central1.run.app/admin/leaderboard"
        : "https://lms1-494718652739.us-central1.run.app/leaderboard";
  ...
  const handleSearch = async () => {
    try {
      const res = await axios.get(`https://lms1-494718652739.us-central1.run.app/admin/leaderboard/search/${searchUsername}`);
  ...
  const modifyPoints = async (username, action) => {
    try {
      await axios.post(`https://lms1-494718652739.us-central1.run.app/admin/leaderboard/${action}point/${username}`);
      fetchLeaderboard();
    } catch (error) {
